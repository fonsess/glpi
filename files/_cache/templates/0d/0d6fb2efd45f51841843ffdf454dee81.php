...
class __TwigTemplate_6eee568060c5339c2c1640ea95cf99ec extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"POST\" action=\"{{ form_path }}\" enctype=\"{{ enctype }}\"
   ...
   {% if params['_hidden_fields'] is defined and params['_hidden_fields']|length > 0 %}
      ...
      {% endfor %}
   {% endif %}
", "components/itilobject/mainform_open.html.twig", "C:\\xampp\\htdocs\\glpi\\templates\\components\\itilobject\\mainform_open.html.twig");
    }
}

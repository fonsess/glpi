...
class __TwigTemplate_08692c681d7b907db5c65f851e2c61bd extends Template
{
    private $source;
    private $macros = [];
...
($context["rand"] ?? null)]], 199, $context, $this->getSourceContext());
            ...
            echo "
               ";
            // line 250
            if (((($__internal_compile_19 = twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "fields", [], "any", false, false, false, 250)) && is_array($__internal_compile_19) || $__internal_compile_19 instanceof ArrayAccess ? ($__internal_compile_19["id"] ?? null) : null) <= 0)) {
                // line 251
...
{% block timeline_card %}
   ...
   {% endif %}
{% endblock %}
", "components/itilobject/timeline/form_followup.html.twig", "C:\\xampp\\htdocs\\glpi\\templates\\components\\itilobject\\timeline\\form_followup.html.twig");
    }
}

...
use PluginTagTag as GlobalPluginTagTag;
...
class PluginTagTag extends CommonDropdown {
   ...
   static function showTagDropdown($params = []) {
      ...
      //ALTERAÇÃO: campo Etiquetas somente leitura se usuário não tem permissão PluginTagTag::canUpdate()
      echo Html::scriptBlock("$(function() {
         $('#tag_select_$rand').select2({
            ...
            tags: true,
            tokenSeparators: [',', ';'],
            disabled: ".(PluginTagTag::canUpdate()? 'false':'true').",
